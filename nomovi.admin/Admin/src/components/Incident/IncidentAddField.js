...
class IncidentAddField extends React.Component {
                    ...
                    <Col sm={12}>
                        <div className="m-custom-incident">
                            <Breadcrumb>
                                ...
                                <Breadcrumb.Item>IncidentAddField</Breadcrumb.Item>
                            </Breadcrumb>
...
export default withRouter(IncidentAddField)
